...
defmodule OperationsWeb.OperatorLive.Login do
  ...
  def handle_event("submit_magic", %{"operator" => %{"email" => email}}, socket) do
    if operator = Accounts.get_operator_by_email(email) do
  ...
  defp local_mail_adapter? do
    Application.get_env(:operations, Operations.Mailer)[:adapter] == Swoosh.Adapters.Local
  end
end
